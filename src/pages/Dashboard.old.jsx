...
import { FaUser, FaBook, FaBrain, FaBell, FaArrowRight, FaChevronDown, FaChevronUp, FaChartLine, FaCreditCard, FaCheckCircle, FaExclamationTriangle, FaGraduationCap, FaPlus, FaSync, FaCalendarAlt, FaUpload } from 'react-icons/fa';
...
const Dashboard = () => {
  ...
  const getMainClasses = () => {
    let classes = 'flex-1 px-4 py-4';
    
    // Adjust spacing for different screen sizes
    if (isMobile) {
      classes += ' space-y-4';
    } else if (isTablet) {
      classes += ' space-y-6 px-6';
    } else {
      classes += ' space-y-8 px-8';
    }
